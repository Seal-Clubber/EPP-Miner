...
constexpr static uint32_t kEpoch_length = 7500;  // Ravencoin
//constexpr static uint32_t kEpoch_length = 12000;  // Evrprogpow
...
//constexpr static uint32_t kFull_dataset_init_size = (1U << 30)*3; // Evrprogpow
constexpr static uint32_t kFull_dataset_init_size = (1U << 30); // Ravencoin
